...
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.5cm,width=6.5cm,xlabel={Threads [1]},ylabel={Runtime [s]}]
        \addplot[color=black,mark=x]
            coordinates
            {
                (1,42.500)
...
\end{axis}
\begin{axis}[name=plot2,at={($(plot1.east)+(1.7cm,0)$)},anchor=west,height=6.5cm,width=6.5cm,xlabel={Threads},ylabel={Runtime [s]}]
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (2,16.407) (4,9.053) (5,7.355) (8,4.665) (10,3.761) (20,1.979)
        ...
        \addplot[color=fzjgreen,mark=x]
            ...
            \addlegendentry{HPX foreach}
        \addplot[color=fzjred,mark=x]
            coordinates
            {
                (2,1.6035) (4,8.848) (5,7.142) (8,4.501) (10,3.615) (20,1.882)
            };
