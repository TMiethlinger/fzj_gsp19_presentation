...
\begin{itemize}
  ...
  \item Message-driven
  \item Distributed shafzjred memory
  \item Multi-threaded
...
\begin{tabular}{ |c|c| } 
 ...
 AGAS (active global address space) & shafzjred memory \\
 \hline
\end{tabular}
\end{center}
\vspace{0.3cm}
...
% \begin{frame}
% \frametitle{HPX: An example program}
% \lstinputlisting[language=C]{area.cpp}
% \end{frame}
