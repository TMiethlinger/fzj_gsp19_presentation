...
\begin{frame}
\frametitle{QR decomposition}
\framesubtitle{Algorithm: Householder Reflection}
Example: \(3 \times 3 \times 3 \times 3\) block matrix.
\begin{center}
\begin{tikzpicture}[
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.0cm,width=6.0cm,xlabel={Threads \(T\)},ylabel={Runtime [s]},legend style={font=\tiny}]
...
\end{axis}
\begin{axis}[name=plot2,at={($(plot1.east)+(1.7cm,0)$)},anchor=west,height=6.0cm,width=6.0cm,xlabel={Threads \(T\)},ylabel={Runtime [s]},legend style={font=\tiny}]
        \addplot[color=fzjorange,mark=+]
            coordinates
            {
                (2,16.407) (4,9.053) (5,7.355) (8,4.665) (10,3.761) (20,1.979)
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.0cm,width=12cm,xlabel={Threads \(T\)},ylabel={Runtimes Ratio [1]},legend style={font=\tiny}]
        \addplot[color=fzjorange,mark=+]
            coordinates
            {
...
\end{center}
\begin{itemize}
 \item Task-size crucial for HPX. Here the block size was too big.
 \item HPX distributed is quite slower than MPI. The implementations are equivalent/analogous.
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{GEMM Shared Memory}
Let \(m = n = p = 4000, T = 4\), vary number of blocks \(B := M = N = P\):
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.0cm,width=6.0cm,xlabel={Number of Blocks \(B\)},ylabel={Runtimes [s]},legend style={font=\tiny}]
        \addplot[color=fzjorange,mark=+]
            coordinates
            {
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis}[name=plot2,at={($(plot1.east)+(1.7cm,0)$)},anchor=west,height=6.0cm,width=6.0cm,xlabel={Number of Blocks \(B\)},ylabel={Runtimes Ratio [1]},legend style={font=\tiny}]
        \addplot[color=fzjorange,mark=+]
            coordinates
            {
...
\part{Benchmark: Results for QR}
\makepart

\begin{frame}
\frametitle{QR Shared Memory}
Let \(m = 4000, M = 40\), vary number of threads:
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.0cm,width=6.0cm,xlabel={Threads \(T\)},ylabel={Runtime [s]},legend style={font=\tiny}]
        \addplot[color=black,mark=square]
        ...
        \addplot[color=fzjblue,mark=x]
            ...
            \addlegendentry{HPX Shared V2}
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (2,22.9338) (4,12.595) (5,10.242) (8,6.573) (10,5.364) (16,3.544) (20,2.957) (25,2.538) (32,2.681)
            };
            \addlegendentry{HPX Shared V3}
\end{axis}
\begin{axis}[name=plot2,at={($(plot1.east)+(1.7cm,0)$)},anchor=west,height=6.0cm,width=6.0cm,xlabel={Threads \(T\)},ylabel={Runtime Ratio [1]},legend pos=north west,legend style={font=\tiny}]
        \addplot[color=fzjblue,mark=x]
            coordinates
            {
                (2,1) (4,1) (5,1) (8,1) (10,1) (16,1) (20,1) (25,1) (32,1)
            };
            \addlegendentry{HPX Shared V2}
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (2,22.9338/22.913) (4,12.595/12.690) (5,10.242/10.220) (8,6.573/6.572) (10,5.364/5.337) (16,3.544/3.535) (20,2.957/2.957) (25,2.538/2.565) (32,2.681/2.606)
            };
            \addlegendentry{HPX Shared V3}
\end{axis}
\end{tikzpicture}
...
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.0cm,width=6.0cm,ymode=log,xlabel={Threads \(T\)},xmin=0,ylabel={Runtime [ms]},ymax=10,legend pos=north west,legend style={font=\tiny}]
        \addplot[color=black,mark=square]
            coordinates
            {
                (1,0.057841)
        ...
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (1,0.06758869) (4,0.374) (16,1.282) (25,1.890) (36,2.704)
            };
            \addlegendentry{HPX Shared V3}
\end{axis}
\begin{axis}[name=plot2,at={($(plot1.east)+(1.7cm,0)$)},anchor=west,height=6.0cm,width=6.0cm,xlabel={Threads \(T\)},ylabel={Runtime Ratio [1]},ymax=1.03,legend style={font=\tiny}]
        \addplot[color=fzjblue,mark=x]
            coordinates
            {
                (1,1) (4,1) (16,1) (25,1) (36,1)
            };
            \addlegendentry{HPX Shared V2}
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (1,0.06758869/0.06749695) (4,0.374/0.403) (16,1.282/1.290) (25,1.890/1.943) (36,2.704/2.886)
            };
            \addlegendentry{HPX Shared V3}
\end{axis}
\end{tikzpicture}
...
% \begin{itemize}
%  \item Task-size crucial for HPX. Here the block size was too big.
%  \item HPX distributed quite slower than MPI. The implementations are equivalent/analogous.
% \end{itemize}
\end{frame}
...
\begin{axis}[name=plot1,height=6.0cm,width=6.0cm,xlabel={Number of Blocks \(B\)},ylabel={Runtimes [s]},legend style={font=\tiny}]
        \addplot[color=fzjblue,mark=x]
            coordinates
            {
                (4,18.897) (8,14.043) (16,12.753) (20,12.398) (32,12.450) (40,12.584) (80,18.430) (100,21.120)
            };
            \addlegendentry{HPX Shared V2}
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (4,18.890) (8,14.195) (16,12.804) (20,12.453) (32,12.434) (40,12.599) (80,19.044) (100,22.126)
            };
            \addlegendentry{HPX Shared V3}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[name=plot2,at={($(plot1.east)+(1.7cm,0)$)},anchor=west,height=6.0cm,width=6.0cm,xlabel={Number of Blocks \(B\)},ylabel={Runtimes Ratio [1]},legend style={font=\tiny}]
        \addplot[color=fzjblue,mark=x]
            coordinates
            {
                (4,1) (8,1) (16,1) (20,1) (32,1) (40,1) (80,1) (100,1)
            };
            \addlegendentry{HPX Shared V2}
        \addplot[color=fzjorange,mark=x]
            coordinates
            {
                (4,18.890/18.897) (8,14.195/14.043) (16,12.804/12.753) (20,12.453/12.398) (32,12.434/12.450) (40,12.599/12.584) (80,19.044/18.430) (100,22.126/21.120)
            };
            \addlegendentry{HPX Shared V3}
\end{axis}
\end{tikzpicture}
