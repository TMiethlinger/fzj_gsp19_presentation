...
\begin{center}
\begin{tikzpicture}
\begin{axis}[name=plot1,height=6.0cm,width=13.0cm,ymode=log,xlabel={Nodes \(\mathcal{N}\)},xmin=0,xmax=10,ylabel={Runtime [ms]},legend style={font=\tiny}]
...
\end{tikzpicture}
\end{center}
HPX distributed is slower than MPI
\end{frame}
