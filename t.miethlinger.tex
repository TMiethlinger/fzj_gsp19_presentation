...
\begin{tabular}{ |l|l| }
 ...
 \texttt{hpx::when\_all, hpx::when\_any} & Waiting on one or more futures (non blocking) \\
 \texttt{hpx::wait\_all, hpx::wait\_any} & Waiting on one or more futures (blocking) \\
